...
Autodesk.ADN.Viewing.Extension.ModelLoader = function (viewer, options) {
  ...
  var API = {
    ...
    loadModel: function(path, opts) {
      ...
      return new Promise(async(resolve, reject)=> {
        ...
        viewer.loadModel(path, opts, (model)=> {
  ...
  this.load = function() {
    ...
    require.config({
      ...
      baseUrl: 'uploads/extensions/Autodesk.ADN.Viewing.Extension.ModelLoader',
    ...
    require(modules, function(inspireTree) {
  ...
  var ModelLoaderPanel = function(
    parentContainer, panelId, btnElement, InspireTree) {
    ...
    async function initialize() {
      ...
      var models = await API.getGalleryModels();
