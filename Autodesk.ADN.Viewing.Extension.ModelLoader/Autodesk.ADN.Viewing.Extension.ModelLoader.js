  ...
  Autodesk.ADN.Viewing.Extension.ModelLoader.Panel = function(
    ...
    var html = [
      '<form class="form-inline" role="form">',
        '<input id="' + id +'-filter" type="text" class="model-loader-search form-control row" placeholder="Search Models ...">',
        '<input id="' + id +'-scale" type="text" class="model-loader-scale form-control row" placeholder="Scale">',
      '</form>',
